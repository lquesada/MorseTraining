const langData = {
    ...
    "META_DESC": "Μάθετε τον κώδικα Μορς με παιχνίδια και υποστήριξη για πλήκτρα Μορς στην οθόνη ή εξωτερικά",
    "LOGO_ALT": "Λογότυπο Morse Training",
    "APP_TITLE": "Εκπαίδευση Morse",
    "APP_SUBTITLE": "Μάθετε τον κώδικα Μορς με παιχνίδια και υποστήριξη για πλήκτρα Μορς στην οθόνη ή εξωτερικά",
    "SCREENSHOTS_TITLE": "Στιγμιότυπα",
    "SCREENSHOT_1_ALT": "Morse Keyer",
    "SCREENSHOT_2_ALT": "Εκπαιδευτής Morse Transmit",
