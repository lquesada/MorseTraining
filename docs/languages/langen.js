// English translations for the Morse Training website
...
const langData = {
    ...
    // HEADER
    // ==========================================
    // Alt text for the main app logo
    ...
    // BUTTONS
    // ==========================================
    // Alt text for the Google Play download badge
    ...
    // DOWNLOAD SECTION
    // ==========================================
    // Title for the download section at the bottom
    "DOWNLOAD_TITLE": "Download",
    // First paragraph in the download section regarding Google Play
    "DOWNLOAD_TEXT_1": "It is preferable to <a href=\"https://play.google.com/store/apps/details?id=com.qft8.morsekeyer\" style=\"color: #a78bfa; font-weight: 600;\">get the app from the Google Play Store</a>.",
    ...
    // Link back to the main page (used in privacy policy)
