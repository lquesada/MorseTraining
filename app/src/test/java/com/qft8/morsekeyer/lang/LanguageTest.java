        ...
        for (Map.Entry<String, MorseLanguage> entry : languages.entrySet()) {
            ...
            for (Map.Entry<String, String> strEntry : strings.entrySet()) {
                ...
                if (val != null && val.equals(enVal)) {
                    ...
                    if (key.equals("VOLUME") || key.equals("TARGET") || key.equals("RESET") || key.equals("START") || key.startsWith("COLOR_") || key.equals("BACK") || key.equals("NEXT_LEVEL") || key.equals("TRY_AGAIN") || key.equals("REPEAT") || key.equals("CONTINUE") || key.equals("KOCH_METHOD") || key.equals("LEVEL") || key.equals("SCORE") || key.equals("CUSTOM_LEVEL") || key.equals("SELECT_CHARACTERS_PROMPT") || key.equals("AUDIO") || key.equals("CLICKS") || key.equals("PADDLES_STANDARD") || key.equals("PROSIGNS")) {
                        continue;
                    }
                    hasError = true;
